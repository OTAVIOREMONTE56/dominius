...
const server=http.createServer(async(req,res)=>{
  try {
    ...
    if(!/^\/(index\.html|app\.js|game-rules\.js|multiplayer\.js|styles\.css|multiplayer\.css|supabase-(config\.js|client\.js|online\.js|online\.css)|vendor\/supabase\.js|account\.(js|css)|bot\.js|audioManager\.js|assets\/[\w./ -]+)$/.test(file)||file.split('/').includes('..')) {res.writeHead(404);res.end();return;}
