...
const FACTIONS = {
  romanos: {
    ...
    images: {
      objective: 'optimized/objetivo.webp',
      trap: 'optimized/armadilha.webp',
      rank10: 'optimized/cesar.webp',
      rank9: 'optimized/rank-9.webp',
      rank8: 'optimized/rank-8.webp',
      rank7: 'optimized/rank-7.webp',
      rank6: 'optimized/rank-6.webp',
      rank5: 'optimized/rank-5.webp',
      rank4: 'optimized/rank-4.webp',
      rank3: 'optimized/rank-3.webp',
      rank2: 'optimized/rank-2.webp',
      rank1: 'optimized/rank-1.webp',
    },
  },
  orcs: {
    label: 'Orcs',
  ...
  elfos: {
    ...
    images: {
      objective: 'optimized/objetivo.webp', trap: 'optimized/armadilha.webp',
      rank10: 'optimized/rank-10.webp', rank9: 'optimized/rank-9.webp', rank8: 'optimized/rank-8.webp',
      rank7: 'optimized/rank-7.webp', rank6: 'optimized/rank-6.webp', rank5: 'optimized/rank-5.webp',
      rank4: 'optimized/rank-4.webp', rank3: 'optimized/rank-3.webp', rank2: 'optimized/rank-2.webp', rank1: 'optimized/rank-1.webp',
    },
  },
  anoes: {
    label: 'Anões',
  ...
  state.players = factionKeys.map((factionKey, playerIndex) => {
    ...
    Object.entries(PIECE_COUNTS).forEach(([roleKey, count]) => {
      for (let index = 0; index < count; index += 1) {
        ...
        const fileName = faction.images?.[roleKey] || '';
